...
namespace YekiUygulaması01._03 {
    ...
    public partial class KursDataSet : global::System.Data.DataSet {
        ...
        public partial class UsersDataTable : global::System.Data.TypedTableBase<UsersRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public UsersRow AddUsersRow(string username, string password, int yetki) {
        ...
        public partial class UsersRow : global::System.Data.DataRow {
            ...
            public int yetki {
                get {
                    return ((int)(this[this.tableUsers.yetkiColumn]));
                }
                set {
...
namespace YekiUygulaması01._03.KursDataSetTableAdapters {
    ...
    public partial class UsersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Users] WHERE (([id] = @Original_id) AND ([username] = @Origina" +
                "l_username) AND ([password] = @Original_password) AND ([yetki] = @Original_yetki" +
                "))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Users] ([username], [password], [yetki]) VALUES (@username, @p" +
                "assword, @yetki);\r\nSELECT id, username, password, yetki FROM Users WHERE (id = S" +
                "COPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Users] SET [username] = @username, [password] = @password, [yetki] = @yetki WHERE (([id] = @Original_id) AND ([username] = @Original_username) AND ([password] = @Original_password) AND ([yetki] = @Original_yetki));
SELECT id, username, password, yetki FROM Users WHERE (id = @id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::YekiUygulaması01._03.Properties.Settings.Default.KursConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id, username, password, yetki FROM dbo.Users";
        ...
        public virtual int Fill(KursDataSet.UsersDataTable dataTable) {
        ...
        public virtual KursDataSet.UsersDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            KursDataSet.UsersDataTable dataTable = new KursDataSet.UsersDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(KursDataSet.UsersDataTable dataTable) {
        ...
        public virtual int Delete(int Original_id, string Original_username, string Original_password, int Original_yetki) {
            ...
            this.Adapter.DeleteCommand.Parameters[3].Value = ((int)(Original_yetki));
        ...
        public virtual int Insert(string username, string password, int yetki) {
            if ((username == null)) {
        ...
        public virtual int Update(string username, string password, int yetki, int Original_id, string Original_username, string Original_password, int Original_yetki, int id) {
            if ((username == null)) {
                throw new global::System.ArgumentNullException("username");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string username, string password, int yetki, int Original_id, string Original_username, string Original_password, int Original_yetki) {
            return this.Update(username, password, yetki, Original_id, Original_username, Original_password, Original_yetki, Original_id);
        }
    }
